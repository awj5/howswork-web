...
export const metadata: Metadata = {
  ...
  description:
    "HowsWork is a safe, anonymous way for employees to speak up, giving employers real-time visibility into psychosocial risks and evidence of proactive WHS compliance.",
  icons: {
    icon: [
