...
const features = [
  {
    name: "Secure submission.",
    description: "Concerns are fully encrypted and cannot be traced back to the individual.",
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="mb-16 sm:mb-24 lg:mb-0 lg:shrink-0 lg:grow">
            <svg role="img" viewBox="0 0 366 729" className="mx-auto w-91.5 max-w-full drop-shadow-xl">
              ...
              >
                <img alt="" src="/img/how-it-works/concern.png" className="dark:hidden" />
                <img alt="" src="/img/how-it-works/concern-dark.png" className="not-dark:hidden" />
              </foreignObject>
            </svg>
          </div>

          <div className="lg:pt-4">
            <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">For employees</h2>
